...
import { rTokenDistributionAtom, rTokenYieldAtom } from "state/atoms"
        ...
        <Box {...props} variant="layout.borderBox" p={0}>
            <Grid gap={0} columns={1}>
                ...
                >
                    ...
                    <IconInfo icon={<Image src="/svgs/trendup.svg" />} title="" text={`${balance.toString()} rMAV`} />
                </Box>
...
const About = (props: BoxProps) => (
    <Box variant="layout.borderBox" p={4} {...props}>
        ...
        <Text as="p" variant="legend">
            Delta pools assets from 2 third-party protocols (e.g. Aave & Compound), and allows users to split the risk
            of the collateral behind your tokens into two tranches: A & B. If any of the third-party protocol suffers
            losses during the insurance period, those losses are born by the B-tranche holders. We effectively split the
            redemption rights into a riskier and less risky version and allow the market for A- and B- tranches to
            determine the fair risk premium in line with the users' expectations.
        </Text>
