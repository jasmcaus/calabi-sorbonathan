...
const Portfolio = (props: BoxProps) => {
    ...
    return (
        <Box {...props}>
            <Box ml={3} mt={2}>
                <Text variant="sectionTitle">"Staked RSR + Rtoken Value"</Text>
                <Text mt={0} pt={0} sx={{ fontSize: [4, 7], fontWeight: 400, color: "boldText" }} as="h1">
            ...
            {stTokens?.length > 0 && (
                <Box mt={5}>
                    <Text pl={3} variant="sectionTitle">
                        "Your staked RSR positions"
                    </Text>
                    <Table mt={3} mb="-16px" maxHeight={220} columns={stTokenColumns} data={stTokens} />
                </Box>
            )}
