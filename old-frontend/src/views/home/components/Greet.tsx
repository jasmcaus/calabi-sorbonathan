            ...
            <Flex {...props} mt={6} mb={8}>
                <Box ml={3} pr={3} mb={[0, 6]}>
                    ...
                    <Text as="p" variant="legend" sx={{ maxWidth: 520 }}>
                        " Register.app is an independent project but with tight collaboration with the core team of the
                        Reserve project. It’s created as the first Explorer/UI to interact with RTokens in different
                        ways. "
                    </Text>
                    <Box mt={4}>
                        <SmallButton
