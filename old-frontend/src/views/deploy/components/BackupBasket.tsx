    ...
    <Box>
        <Box sx={{ opacity: "40%" }}>
            ...
            <Box sx={{ textAlign: "center" }} py={8} px={4}>
                <EmptyBoxIcon />
                <Text sx={{ fontWeight: 500, display: "block" }}>"Emergency Collateral"</Text>
                <Text variant="legend" sx={{ fontSize: 1 }}>
                    " Each target unit of your primary basket will have defined emergency collateral to replace with in
                    case of default. "
                </Text>
            </Box>
        </Box>
