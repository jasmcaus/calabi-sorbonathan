...
const CustomCollateral = ({ onAdd }: { onAdd(collateral: CollateralPlugin): void }) => {
        ...
        return (
            <Box>
                <Box>
                    ...
                    <Input mt={2} onChange={handleChange} value={address} placeholder={t`Input plugin address`} />
                    {error && address && (
    ...
    return (
        <Flex variant="layout.verticalAlign">
            <Box>
                <Text>"Made your own collateral?"</Text>
                <Text variant="legend" mt={1} sx={{ fontSize: 1, display: "block" }}>
                    "Use a custom plugin contract address"
                </Text>
            </Box>
