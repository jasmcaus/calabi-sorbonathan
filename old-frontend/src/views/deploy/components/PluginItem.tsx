...
const PluginInfo = ({ data }: { data: CollateralPlugin }) => (
    <>
        ...
        <Flex variant="layout.verticalAlign" ml={4} mt={3} sx={{ fontSize: 1 }}>
            <Box mr={4}>
                <Text variant="legend">"Reference unit"</Text>
                <Text sx={{ display: "block" }}>{data.referenceUnit}</Text>
            </Box>
            <Box mr={4}>
                <Text variant="legend">"Collateral token"</Text>
                <Link
                    as="a"
            ...
            <Box>
                <Text variant="legend">"Decimals"</Text>
            ...
            <Flex variant="layout.verticalAlign">
                ...
                <Box ml={3}>
                    ...
                    <Text sx={{ fontSize: 1, display: "block" }} variant="legend">
                        ...
                        {data.custom ? <>| "Custom"</> : `| ${"description" in data ? data.description : ""}`}
                    </Text>
                </Box>
                <Box mx="auto" />
                <label>
                ...
                <IconButton sx={{ cursor: "pointer" }} ml={-1} onClick={() => setVisible(!isVisible)}>
