...
const EmergencyCollateral = ({
    ...
    const handleRemove = (index: number) => {
        updateBasket([
            targetUnit,
            {
                diversityFactor: diversityFactor === collaterals.length ? diversityFactor - 1 : diversityFactor,
    ...
    return (
        <Box {...props}>
            ...
            <Divider my={4} />
            <Flex variant="layout.verticalAlign">
                <Text>"Diversity factor"</Text>
                {readOnly ? (
                    <Box sx={{ backgroundColor: "lightBackground", borderRadius: 16 }} ml="auto" px={3}>
                        ...
                        {collaterals.map((collateral, index) => (
                            <SortableItem id={collateral.address} key={collateral.address}>
                                <Flex mt={3} variant="layout.verticalAlign">
                                    ...
                                    <IconButton sx={{ cursor: "pointer" }} onClick={() => handleRemove(index)}>
