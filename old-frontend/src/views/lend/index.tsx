...
import {
    blockTimestampAtom,
    isLendModalVisibleAtom,
    isWalletModalVisibleAtom,
    isWithdrawModalVisibleAtom,
    poolsAtom,
} from "state/atoms"
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                Header: t`APY`,
                accessor: "lendApy",
                Cell: (cell: any) => <Text sx={{ color: "green" }}>{(cell.cell.value as number).toFixed(2)}%</Text>,
            },
            {
                Header: "",
                accessor: "maxDeposit",
        ...
        <>
            ...
            <Box {...props}>
                ...
                {data.length ? (
                    ...
                    >
                        {/* <Text>
                            "No lending markets available. Something has probably gone wrong."
                        </Text> */}
                    </Box>
                )}
            </Box>
...
const Lend = () => {
    ...
    return (
        <Container>
            <ContentHead title={`Lend Assets`} subtitle={t``} mb={7} ml={5} />
