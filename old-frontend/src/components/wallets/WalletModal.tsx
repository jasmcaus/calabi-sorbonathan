...
const WalletModal = () => {
    ...
    return (
        <Modal title={!connecting ? t`Connect your wallet` : ""} style={{ width: 400 }} onClose={onClose}>
            <Box>
                {connecting ? (
                    <Flex
                        sx={{
                    ...
                    <>
                        {wallets.map(({ icon, label, type, connector }) => (
                            ...
                            >
                                ...
                                <Box mx="auto" />
                                {getConnectorType(currentConnector as any) === type && account ? (
                                    <SelectedIcon />
                                ) : (
                                    <ChevronRight color="var(--theme-ui-colors-secondaryText)" size={18} />
                                )}
                            </Box>
                        ))}
