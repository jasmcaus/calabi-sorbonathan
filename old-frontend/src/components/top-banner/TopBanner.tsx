...
const TopBanner = ({ id }: Props) => {
    ...
    return (
        ...
        >
            <Text>
                <strong>FYI</strong>, there has been a recent basket change to RSV that is temporarily affecting the
                metrics shown below.
            </Text>
            <Text sx={{ cursor: "pointer", display: "block" }} mx={3} variant="legend" onClick={handleDismiss}>
                Dismiss
            </Text>
            <Text
                as="a"
