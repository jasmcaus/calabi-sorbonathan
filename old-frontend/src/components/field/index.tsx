...
export const FormField = ({ placeholder, name, options, textarea = false, disabled, ...props }: FormFieldProps) => {
    const {
        register,
        formState: { errors },
    } = useFormContext()
...
export const FormFieldRange = ({ name, options, min = 0, max = 100, ...props }: FormFieldProps) => {
