...
export interface StRsrInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setRewardPeriod", values: [PromiseOrValue<BigNumberish>]): string
...
export interface StRsr extends BaseContract {
    ...
    callStatic: {
        ...
        setRewardPeriod(val: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>
