...
export interface DeployerInterface extends utils.Interface {
    ...
    getFunction(
        nameOrSignatureOrTopic: "ENS" | "deploy" | "gnosis" | "implementations" | "rsr" | "rsrAsset"
    ): FunctionFragment
...
export type RTokenCreatedEvent = TypedEvent<[string, string, string, string], RTokenCreatedEventObject>
