...
export interface FacadeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "currentAssets", values: [PromiseOrValue<string>]): string
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: "runAuctionsForAllTraders", values: [PromiseOrValue<string>]): string
    encodeFunctionData(functionFragment: "stToken", values: [PromiseOrValue<string>]): string
    encodeFunctionData(functionFragment: "totalAssetValue", values: [PromiseOrValue<string>]): string
...
export interface Facade extends BaseContract {
    ...
    callStatic: {
        ...
        runAuctionsForAllTraders(rToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>

        stToken(rToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>

        totalAssetValue(rToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
    }
