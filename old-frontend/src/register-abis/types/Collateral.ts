...
export type DefaultStatusChangedEvent = TypedEvent<[number, number], DefaultStatusChangedEventObject>
...
export interface Collateral extends BaseContract {
    ...
    functions: {
        ...
        getClaimCalldata(overrides?: CallOverrides): Promise<[string, string] & { _to: string; _cd: string }>
    ...
    estimateGas: {
        ...
        price(allowFallback: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>
    ...
    populateTransaction: {
        bal(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
        ...
        price(allowFallback: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>
