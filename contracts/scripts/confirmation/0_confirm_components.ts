...
import { getDeploymentFile, getRTokenDeploymentFilename, IRTokenDeployments } from "../deployment/common"
...
async function main() {
    ...
    if (isMainnet) {
        ...
        const timelock = await hre.ethers.getContractAt("TimelockController", rTokenDeployments.timelock)
