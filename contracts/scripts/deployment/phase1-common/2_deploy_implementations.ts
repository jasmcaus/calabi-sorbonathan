...
async function main() {
    ...
    writeComponentDeployment(deployments, deploymentFilename, "assetRegistry", assetRegImpl.address, "AssetRegistry")
    ...
    writeComponentDeployment(deployments, deploymentFilename, "basketHandler", bskHndlrImpl.address, "BasketHandler")
    ...
    writeComponentDeployment(deployments, deploymentFilename, "distributor", distribImpl.address, "Distributor")
    ...
    writeComponentDeployment(deployments, deploymentFilename, "furnace", furnaceImpl.address, "Furnace")
    ...
    writeComponentDeployment(deployments, deploymentFilename, "rsrTrader", revTraderImpl.address, "RSR Trader")
    writeComponentDeployment(deployments, deploymentFilename, "rTokenTrader", revTraderImpl.address, "RToken Trader")
