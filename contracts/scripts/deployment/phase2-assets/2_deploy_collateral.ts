...
async function main() {
    ...
    console.log(`Deployed StaticAToken for aDAI on ${hre.network.name} (${chainId}): ${adaiStaticToken.address} `)
    ...
    // Get AToken to retrieve name and symbol
    aToken = <ATokenMock>await ethers.getContractAt("ATokenMock", networkConfig[chainId].tokens.aUSDC as string)
    ...
    console.log(`Deployed StaticAToken for aUSDC on ${hre.network.name} (${chainId}): ${ausdcStaticToken.address} `)
    ...
    // Get AToken to retrieve name and symbol
    aToken = <ATokenMock>await ethers.getContractAt("ATokenMock", networkConfig[chainId].tokens.aUSDT as string)
    ...
    console.log(`Deployed StaticAToken for aUSDT on ${hre.network.name} (${chainId}): ${ausdtStaticToken.address} `)
    ...
    // Get AToken to retrieve name and symbol
    aToken = <ATokenMock>await ethers.getContractAt("ATokenMock", networkConfig[chainId].tokens.aBUSD as string)
    ...
    console.log(`Deployed StaticAToken for aBUSD on ${hre.network.name} (${chainId}): ${abusdStaticToken.address} `)
    ...
    // Get AToken to retrieve name and symbol
    aToken = <ATokenMock>await ethers.getContractAt("ATokenMock", networkConfig[chainId].tokens.aUSDP as string)
    ...
    console.log(`Deployed StaticAToken for aUSDP on ${hre.network.name} (${chainId}): ${ausdpStaticToken.address} `)
    ...
    let cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cDAI as string)
    fallbackPrice = fp("1")
    ...
    cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cUSDC as string)
    fallbackPrice = fp("1")
        .mul(await cToken.exchangeRateStored())
        .div(bn("1e16"))
    ...
    cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cUSDT as string)
    fallbackPrice = fp("1")
        .mul(await cToken.exchangeRateStored())
        .div(bn("1e16"))
    ...
    cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cUSDP as string)
    ...
    cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cWBTC as string)
    ...
    cToken = await hre.ethers.getContractAt("CTokenMock", networkConfig[chainId].tokens.cETH as string)
