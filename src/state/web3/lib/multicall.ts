 ...
 * Multicall2
 */
async function multicall(provider: Provider, multicallAddress: string, requests: RawCall[]): Promise<MulticallState> {
...
export const promiseMulticall = async (calls: ContractCall[], provider: Web3Provider): Promise<any[]> => {
