...
export const isValidRedeemAmountAtom = atom((get) =>
    isValid(Number(get(redeemAmountAtom) || 0), get(maxRedeemableAtom))
)
export const maxIssuableAtom = atom(5000)
...
export const isValidWithdrawAmountAtom = atom((get) =>
    isValid(Number(get(withdrawAmountAtom) || 0), get(maxWithdrawAtom))
)
