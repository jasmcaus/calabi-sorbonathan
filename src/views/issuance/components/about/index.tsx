    ...
    <Box variant="layout.borderBox" p={4} sx={{ height: "fit-content" }}>
        ...
        <Text as="p" variant="legend">
            <Trans>
                ...
                RTokens immediately or mint them over the period of a few blocks (a "slow mint"). "Slow mints" are
                designed into the protocol to ensure stability of the RToken's price and redemption rate while there are
                ongoing mints and revenue operations.
            </Trans>
            <br />
            <br />
            <Trans>To learn more about minting and redemption operations, read the documentation</Trans>{" "}
            <Link
