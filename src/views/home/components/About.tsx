            ...
            <Grid columns={[1, 1, 2]} mt={6} pl={4} gap={[4, 4, 7]}>
                <Box>
                    ...
                    <Text variant="legend" as="p">
                        <Trans>
                            ...
                            ideas for what assets should be in the basket, what a good governance looks like, or
                            anything novel that could work within the realms of the protocol, please consider putting
                            those ideas into practice or sharing them with the community.
                        </Trans>
                    </Text>
                    ...
                    <Text variant="legend" as="p">
                        <Trans>
                            Reserve aims to help people around the world maintain their spending power by allowing
                            anyone to create asset-backed currencies with tokenized assets on the Ethereum blockchain in
                ...
                <Box>
                    ...
                    <Text variant="legend" as="p" mb={2}>
                        <Trans>
                            Register is developed and maintained by LC Labs as the first dApp to interact with the
                            Reserve Protocol and various RTokens deployed with the platform.
                        </Trans>
                    </Text>
                    ...
                    <Text variant="legend" as="p" mb={2}>
                        <Trans>
                            LC Labs uses industry standard anonymized analytics tools to understand usage and improve
                            the user experience. LC labs does not collect any information about users or their financial
                            activity.
                        </Trans>
                    </Text>
                    <Text variant="legend" as="p">
