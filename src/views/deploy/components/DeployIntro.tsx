        ...
        <Grid columns={2} sx={{ backgroundColor: "contentBackground", borderRadius: 10 }}>
            <Box px={5} py={4} sx={{ borderRight: "1px solid", borderColor: "border" }}>
                ...
                <StepItem
                    ...
                    mt={4}
                />
                <StepItem title={t`Roles & Permissions`} subtitle={t`Set the guardian, and pauser roles`} mb={4} />
                <StepItem
            ...
            <Box px={5} py={4}>
                <Box>
                    ...
                    <Text as="p" variant="legend" sx={{ fontSize: 2 }}>
                        <Trans>
                            While it doesn’t require deep technical knowledge, this wizard requires you to thoughtfully
                            design a good token. We encourage you to talk to the Reserve team and read the docs to learn
                            more before confirming any transactions.
                        </Trans>
                    </Text>
                    <Flex mt={3}>
                        <SmallButton
                            variant="muted"
                            onClick={() => window.open("https://discord.gg/Ryk6P67c", "_blank")}
                            mr={3}
                        >
