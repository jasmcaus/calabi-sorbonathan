...
const Pending = () => (
    <Box sx={{ textAlign: "center", width: 420 }}>
        ...
        <Text as="p" variant="legend">
            <Trans>Please sign the transaction in your wallet to continue with the deployment process.</Trans>
        </Text>
    </Box>
)
...
const Mining = ({ hash }: { hash: string }) => (
    <Box sx={{ textAlign: "center", width: 400 }}>
        ...
        <Text as="p" variant="legend">
            <Trans>
                Meditate peacefully on the stability of a future asset backed reserve currency while your RToken deploys
                🧘‍♂️
            </Trans>
            <br />
            <br />
            <Trans>Please don't close this window to avoid issues finding your way back here.</Trans>
        </Text>
