    ...
    try {
        ...
        const config: RTokenConfiguration = {
            ...
            params: {
                ...
                maxTradeSlippage: parseEther((Number(tokenConfig.maxTradeSlippage) / 100).toString()),
                ...
                scalingRedemptionRate: parseEther((Number(tokenConfig.scalingRedemptionRate) / 100).toString()),
        ...
        for (const targetUnit of Object.keys(basket)) {
            ...
            collaterals.forEach((collateral, index) => {
                ...
                weights.push(parseEther(((Number(distribution[index]) / 100) * Number(scale)).toString()))
            })
