...
import { TableState, UseGroupByState, UseTableHooks, UseExpandedRowProps, UseTableRowProps } from "react-table"
                        ...
                        if (row.canExpand) {
                            return (
                                <td colSpan={row.cells.length}>
                                    <Flex variant="styles.tdgroup" {...row.getToggleRowExpandedProps()}>
                                        {row.isExpanded ? "." : ">"}{" "}
                                        <Text
                                            sx={{
                                                mx: 2,
