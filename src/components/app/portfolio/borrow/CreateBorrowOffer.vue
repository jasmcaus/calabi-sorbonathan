    ...
    <main>
        <div class="header">
            <div class="toolbar">
                ...
                <PrimaryButton
                    :progress="approving || fetchingPrice"
                    v-if="collateralAmount <= 0 || !checkbox"
                    :width="'160px'"
                    :text="'Create'"
                    :state="'disable'"
                />
                ...
                <PrimaryButton
                    v-else-if="Number($fromWei(allowance)) >= Number($fromWei(collateralAmount))"
                    :progress="creating || fetchingPrice"
                    :state="creating || fetchingPrice ? 'disable' : ''"
                ...
                <PrimaryButton
                    ...
                    :text="`Approve ${$findAsset(collateralToken).symbol}`"
                    :width="'200px'"
                />
            </div>
                        ...
                        <div>
                            ...
                            <div class="click_1" v-on:click="dropDown2 = !dropDown2">
                                ...
                                <div class="drop_down" v-show="dropDown2">
                                    <div
                                        class="drop_item"
                                        v-for="asset in $findConjugates(principalToken, collateralToken)"
                                        :key="asset.id"
