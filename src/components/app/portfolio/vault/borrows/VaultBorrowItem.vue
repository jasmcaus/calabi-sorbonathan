    ...
    <main v-if="!fetching && userAddress != null">
        ...
        <div class="dashboard">
            ...
            <div class="second_box">
                <div class="buttons">
                    <RouterLink :to="`/discover/borrowers/${$route.params.id}`">
        ...
        <div class="dashboard" v-if="loan.lender == userAddress.toLowerCase()">
            <div class="firstbox">
                <div class="offer">
                    <div class="first_row">
                        <!---->
                        <div>
                            <IconClock />
                            <p class="deep_text">{{ daysAgoForLaon }} Days <span>ago</span></p>
        ...
        <div class="dashboard dashboard2" v-else-if="offer.creator == userAddress.toLowerCase()">
            <div class="firstbox">
                <div class="offer">
                    <div class="first_row">
                        <div>
                            <IconCalendar />
                            <p class="deep_text">{{ daysAgoForOffer }} Days <span>ago</span></p>
                            <p class="light_text">Time Locked</p>
                        </div>
                        <div>
                            <IconChart />
