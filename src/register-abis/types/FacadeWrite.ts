...
export type ConfigurationParamsStructOutput = [string, string, string, DeploymentParamsStructOutput] & {
    name: string
    symbol: string
    mandate: string
...
export type SetupParamsStructOutput = [string[], string[], BigNumber[], BackupInfoStructOutput[]] & {
    assets: string[]
...
export type GovernanceParamsStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
...
export interface FacadeWriteInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deployRToken" | "deployer" | "setupGovernance"): FunctionFragment

    encodeFunctionData(functionFragment: "deployRToken", values: [ConfigurationParamsStruct, SetupParamsStruct]): string
...
export type GovernanceCreatedEvent = TypedEvent<[string, string, string], GovernanceCreatedEventObject>
